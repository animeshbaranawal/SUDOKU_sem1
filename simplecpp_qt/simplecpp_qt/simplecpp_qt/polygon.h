...
namespace simplecpp{
	...
	protected:
		...
		void init(const double x, const double y, const double points[][2], int count, Composite* owner=NULL);
	...
	//  Polygon(const Polygon& other);
		...
		void reset(const double x, const double y, const double points[][2], int count, Composite* owner=NULL);
